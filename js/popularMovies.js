...
function renderPopularMovies() {
    ...
    renderPagination(itemsToDisplay.length, itemsPerPage);
...
function renderTrendingMovies() {
    ...
    // Get the most recent items (by reversing and taking a slice)
    const trendingItems = itemsToDisplay.slice().reverse().slice(0, itemsPerTrendingSection);
